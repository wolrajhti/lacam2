 ...
 */
function qSort(a, p, r, compare) {
    if (p < r) {
        var q = partition(a, p, r, compare);
 ...
 */
function partition(a, p, r, compare) {
    if (compare === void 0) { compare = comparisons_1.ascendingComparison; }
    var i = p - 1;
    for (var j = p; j < r; j++) {
