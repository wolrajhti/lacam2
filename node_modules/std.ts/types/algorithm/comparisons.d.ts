 ...
 */
export declare type criterion = (x: any, y: any) => number;
/**
 ...
 */
export declare function ascendingComparison(a: any, b: any): number;
/**
 * The standard function checking relationship between a and b.
 * @param a a < b.
 * @param b a < b.
 * @return 0 if a equals b, 1 if a < b, -1 if b > a of a or b are undefined.
 */
export declare function descendingComparison(a: any, b: any): number;
/**
 * Checks if an array is sorted according to the criterion provided.
 ...
 */
export declare function isSorted(a: any[], compare?: criterion): boolean;
